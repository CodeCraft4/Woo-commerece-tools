...
const GeneAI3Popup = (props: GeneAIType) => {
  const { onClose } = props;
  ...
  const createCardDesign = (design: any) => {
    ...
    setSelectedAIimageUrl3(dataUrl);
  };
  ...
  return (
    <PopupWrapper
      ...
      onClose={onClose}
      sx={{ width: 350, height: 600, left: '26%'}}
    >
            ...
            {isAIimage3 && (
              <Box
                ...
                sx={{
                  ...
                  zIndex: 2,
                  cursor: "pointer",
                  bgcolor: isAIimage3 ? "black" : "transparent",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  color: "blueviolet",
              ...
              >
                <Check
                  fontSize="small"
                  sx={{ color: isAIimage3 ? "white" : "black" }}
                />
              </Box>
            )}
          </Box>
